<%@ Page Title="" Language="C#" MasterPageFile="~/View/User/User.Master" AutoEventWireup="true" CodeBehind="NoticeView.aspx.cs" Inherits="社团管理系统.View.User.NoticeView" %>
  ...
  <div class="pos">
      ...
      <br />
        ...
        <div style="top:100px; color:red;">
           <span>公告类型:</span><asp:Label ID="type" runat="server" Text="类型:"></asp:Label><span>公告时间:</span><asp:Label ID="date" runat="server" Text="发布日期:"></asp:Label>
        </div>
          <br />
        <br />
