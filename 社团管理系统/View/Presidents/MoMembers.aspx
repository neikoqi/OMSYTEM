<%@ Page Title="" Language="C#" MasterPageFile="~/View/Presidents/Presidents.Master" AutoEventWireup="true" CodeBehind="MoMembers.aspx.cs" Inherits="社团管理系统.View.Management.WebForm1MoMembers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <script type="text/javascript">
    ...
    <h1 class="text-center">社团成员管理</h1>
    <div>
        <asp:Label class="form-label text-success" ID="frist" runat="server" Text="成员账号"></asp:Label>
       ...
       <div>
        <asp:Label class="form-label text-success" ID="second" runat="server" Text="成员名称"></asp:Label>
     <input class=" form-control" type="text" runat="server" id="secondtb" placeholder="" outocomplete="off" name="second"  >
   
        </div>
       <div>
        <asp:Label class="form-label text-success" ID="Label1" runat="server" Text="性别"></asp:Label>
    ...
    <div> 
        ...
        <asp:Button class="btn-success btn-block btn" ID="changebt" runat="server" Text="修改" OnClick="revise" OnClientClick="bill(PGrid) "  />
